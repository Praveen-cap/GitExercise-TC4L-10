...
level_3 = [
    ...
    "X   XXF   L  L  CX  F    T  XXXX",
    "X   X   XXXXS     XX      XX  XX",
    "XX     F  XXXXX     SXXX  O  XXX",
    "XS  XX   XXO    XX     F    XXXX",
    "XXX   XL  XXXX  X   XXXX   XL XX",
    "XX            XXX   XXX   XK  OX",
    "XXXS  XXX  XXXXXX       XX FXXXX",
    "XXX  O  F  XXXXX     S  XXX   XX",
    "XXX       XXXXX  XXX   XXX L  XX",
    "XXX LXXX      F   XX       O XXX",
    "XXXXX   F   XXXXXXXX  F F    XXX",
    "XK     XXXXXX   YXXXX     L  XXX",
    "XXX    XXX     FXXF          XXX",
    "XXO  F  XX     XX   F     O   XX",
    "XXX  XXX  F  XXXXXO      X   XXX",
    "X XX  F   XXXXXX          XXXXXX",
    "XXXXXOT         F  XXCX X K  XXX",
    "XXXL XXF      LXXXXXX    XX  XXX",
    "XXXX    X  XXXF  F    F XXX  SXX",
    "XXS     XX  X    XO      C    XX",
