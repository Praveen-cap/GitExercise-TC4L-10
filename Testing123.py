...
class PowerUp(turtle.Turtle):
    def _init_(self, shape, power_type):
        super()._init_()
        self.shape(shape)
        self.penup()
        self.speed(0)
...
def open_combat_window():
    ...
    enemy_rect = pygame.Rect(80, 250, 60, 80 )  

    monster_frames = [
        pygame .transform.scale(pygame.image.load("Monster 2.11.png"), (200, 200)),
        pygame.transform.scale(pygame.image.load("Monster 2.22.png"), (200, 200)),
        pygame.transform.scale(pygame.image.load("Monster 2.33.png"), (200, 200)),
        pygame.transform.scale(pygame.image.load("Monster 2.44.png"), (200, 200)),
        pygame.transform.scale(pygame.image.load("Monster 2.55.png"), (200, 200))
    ]
    ...
    frame_width = player_running.get_width() // 10 
    ...
    while True:
        ...
        for bullet in bullets:
            combat_win.blit(fireball_image, (bullet.x, bullet.y))
